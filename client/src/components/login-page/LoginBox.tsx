        ...
        <div className="flex items-center justify-center min-h-screen">
            <div className="bg-darkerGray p-20 rounded-md">
                <div className="flex flex-col">
                    <p className="text-4xl font-bold text-center mb-8 ">BUILD!</p>
                <Input className="mb-1" type="email" placeholder="Email"/>
                <Input className="mb-2" type="password" placeholder="Password"/>


                <Button className="mb-4" variant="login">Log in</Button>
            ...
            <button className="bg-white text-black px-4 py-2 rounded-md shadow flex items-center space-x-2 mb-4">
                ...
                <span className="">Don't have an account? <Link href="/" className="text-customBlue">Sign up</Link></span>
