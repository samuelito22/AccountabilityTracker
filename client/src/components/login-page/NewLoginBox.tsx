    ...
    return(
        ...
        {/*The above div is for creating the layout position of the login box*/}
            <div className="font-plex mb-8">
                ...
                <h2 className="text-gray-500">Welcome back, Builder. Please enter your details</h2>
            </div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="text-black text-sm mt-4 mb-4">
                    ...
                    <div className="w-full ">
                        <Button type="submit" className="w-full mb-2 mt-2"> Log in</Button>
                        <Button type="button" className="w-full"> Log in with X</Button>
                        <div className="flex flex-row m-5 text-center">
                        <p className="mr-2 text-gray-500"> Don't have an account?</p>
                        <Link className="text-right" href="/signup">Sign up</Link>
                        </div>
                    </div>
